package com.example.tobias.run.ui.settings.libraries;
...
import com.example.tobias.run.data.model.LibraryItem;
...
public class LibraryItemsActivityView extends AppCompatActivity {
     ...
     * be instantiated either directly from {@link com.example.tobias.run.ui.settings.SettingsActivityView} or from
